...
var html = document.querySelector("#demo"); /*  先死记 通过CSS选择器找到这个元素*/ //拿到demo
var style = document.querySelector("#style"); //html就是放HTML 的style就是方css的
...
//# sourceMappingURL=main.1a349dad.map